...
class _Column implements Column {
  ...
  _Column(this.index, this.name, this.fieldId, this.tableColNo, this.fieldType,
...
class _Row implements Row {
  ...
  Map<String, dynamic> toMap() =>
      new Map<String, dynamic>.fromIterables(_columnNames, _columnValues);
